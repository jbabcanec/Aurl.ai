...
def test_augmentation_training_integration(test_experiment_dir):
...
def test_augmentation_state_checkpointing_integration(test_experiment_dir):
    """Test that augmentation state is properly saved in checkpoints."""
    
    # Create dataset with augmentation
    data_dir = test_experiment_dir / "data"
    data_dir.mkdir()
...
def test_augmentation_progressive_scheduling(test_experiment_dir):
...
def test_augmentation_statistics_integration(test_experiment_dir):
...
def test_augmentation_integration_comprehensive(test_experiment_dir):
    ...
    # Run all integration components - these are now functions, not class methods
    logger.info("Running individual test functions...")
    
    try:
        logger.info("1️⃣ Testing training integration...")
        test_augmentation_training_integration(test_experiment_dir)
        
        logger.info("2️⃣ Testing checkpoint integration...")
        test_augmentation_state_checkpointing_integration(test_experiment_dir)
        
        logger.info("3️⃣ Testing progressive scheduling...")
        test_augmentation_progressive_scheduling(test_experiment_dir)
        
        logger.info("4️⃣ Testing statistics integration...")
        test_augmentation_statistics_integration(test_experiment_dir)
